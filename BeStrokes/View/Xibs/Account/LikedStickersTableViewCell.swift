...
class LikedStickersTableViewCell: UITableViewCell {
    ...
    func setDesignElements() {
        ...
        Utilities.setDesignOn(label: likedStickerHeadingText, font: Strings.defaultFontBold, fontSize: 20, fontColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), textAlignment: .left, numberofLines: 1, canResize: true, minimumScaleFactor: 0.8)
        Utilities.setDesignOn(button: likedStickerTryMeButtonLabel, title: Strings.tryMeButton, font: Strings.defaultFontBold, size: 14, titleColor: #colorLiteral(red: 0.9529411765, green: 0.9529411765, blue: 0.9647058824, alpha: 1), backgroundColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), isCircular: true)
