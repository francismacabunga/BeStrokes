...
class ProfileTableViewCell: UITableViewCell {
    ...
    func setDesignElements() {
        ...
        Utilities.setDesignOn(label: settingLabelText, font: Strings.defaultFont, fontSize: 15, fontColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), numberofLines: 1, textAlignment: .left)
    }
